  ...
  return (
    <div className="p-10">
      ...
      <p className="text-sm mt-3">
          Không sao nếu bạn chưa nghĩ ra tiêu đề hoặc chọn đúng danh mục bây giờ. Bạn có thể thay đổi chúng sau này.
      </p>
